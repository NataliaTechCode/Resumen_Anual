...
function ShareSocial(props) {
    ...
    function getComponent(type) {
        ...
        return ((0, jsx_runtime_1.jsx)(core_1.Tooltip, Object.assign({ title: type || "", placement: "top" }, { children: (0, jsx_runtime_1.jsx)(Button, Object.assign({ url: url, quote: title, onClick: () => onSocialButtonClicked(type) }, { children: (0, jsx_runtime_1.jsx)(Icon, { size: 40, round: true }) })) })));
    }
